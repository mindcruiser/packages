...
class MethodCallHandlerImpl implements Application.ActivityLifecycleCallbacks, InAppPurchaseApi {
          ...
          (billingResult, productDetailsResult) -> {
            ...
            final PlatformProductDetailsResponse.Builder responseBuilder =
                new PlatformProductDetailsResponse.Builder()
                    ...
                    .setUnfetchedProducts(
                        fromUnfetchedProductList(
                            productDetailsResult.getUnfetchedProductList()));
  ...
  public @NonNull PlatformBillingResult launchBillingFlow(
    ...
    boolean isSubscriptionReplacement =
        params.getOldProduct() != null
    ...
    if (isSubscriptionReplacement) {
      ...
      if (params.getReplacementMode()
        ...
        BillingFlowParams.ProductDetailsParams.SubscriptionProductReplacementParams
            ...
            BillingFlowParams.ProductDetailsParams.SubscriptionProductReplacementParams
                .newBuilder()
                .setOldProductId(params.getOldProduct())
                .setReplacementMode(toReplacementMode(params.getReplacementMode()))
                .build();
