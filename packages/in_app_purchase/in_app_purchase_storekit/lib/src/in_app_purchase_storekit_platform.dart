...
class InAppPurchaseStoreKitPlatform extends InAppPurchasePlatform {
  ...
  ///
  /// Added in this fork from version 3.2.3 of `in_app_purchase`.
  static Stream<SKPaymentWrapper> get shouldAddStorePaymentStream =>
      _sk1transactionObserver.shouldAddStorePaymentController.stream;
  ...
  static void registerPlatform() {
    ...
    if (_useStoreKit2) {
      ...
      _sk1transactionObserver = _TransactionObserver(updateController, shouldAddStorePaymentController);
